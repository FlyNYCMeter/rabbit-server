    ...
    [{description,"RabbitMQ"},
     ...
     {modules,
         [app_utils,background_gc,credit_flow,delegate,delegate_sup,dtree,
          ...
          rabbit_amqqueue_sup,rabbit_auth_backend,rabbit_auth_backend_dummy,
          ...
          rabbit_channel_sup_sup,rabbit_client_sup,rabbit_command_assembler,
          rabbit_connection_helper_sup,rabbit_connection_sup,
          rabbit_control_main,rabbit_ctl_usage,rabbit_dead_letter,
          rabbit_direct,rabbit_disk_monitor,rabbit_error_logger,
          ...
          rabbit_prelaunch,rabbit_queue_collector,rabbit_queue_consumers,
          ...
          test_sup,truncate,vm_memory_monitor,worker_pool,worker_pool_sup,
          worker_pool_worker]},
     {registered,
